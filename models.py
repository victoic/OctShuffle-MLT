...
class OctMLT(nn.Module):
  ...
  def __init__(self, attention = False, multi_scale = True):
    ...
    self.conv7 = OctConv2d(128, 128, 3, padding=1, bias=False, gated=True)
    self.conv8 = OctConv2d(128, 128, 3, padding=1, bias=False, gated=False)
    self.conv8_1 = OctConv2d(128, 128, 3, padding=1, bias=False, gated=True)
    self.conv8_2 = OctConv2d(128, 128, 3, padding=1, bias=False, gated=False)
    self.conv9_1 = OctConv2d(128, 256, 3, padding=1, bias=False, gated=True)
