...
class ModelResNetSep2(nn.Module):
  ...
  def __init__(self, attention = False, multi_scale = True):
    ...
    self.conv5 = OctConv2d(64, 128, (3,3), padding=(1, 1), bias=False)
    self.conv6 = OctConv2d(128, 128, (3,3), padding=1, bias=False)
    self.conv7 = OctConv2d(128,256, 3, padding=1, bias=False)
    self.conv8 = OctConv2d(256, 256, (3,3), padding=1, bias=False)
    self.conv9 = OctConv2d(256, 256, (3,3), padding=(1, 1), bias=False, alpha=(0.5, 0))
    ...
    self.act = OctConv2d(256, 1, (1,1), padding=0, stride=1, alpha=0)
    self.rbox = OctConv2d(256, 4, (1,1), padding=0, stride=1, alpha=0)
    
    self.angle = OctConv2d(256, 2, (1,1), padding=0, stride=1, alpha=0)
...
class ModelMLTRCTW(nn.Module):
  ...
  def __init__(self, attention = False, multi_scale = True):
    ...
    self.act = Conv2d(256, 1, (1,1), padding=0, stride=1, alpha=0)
    self.rbox = Conv2d(256, 4, (1,1), padding=0, stride=1, alpha=0)
    
    self.angle = Conv2d(256, 2, (1,1), padding=0, stride=1, alpha=0)
    self.drop0 = _Dropout2d(p=0.2, inplace=False)
    self.drop1 = Dropout2d(p=0.2, inplace=False)
